...
async function saveNumModal(){
  ...
  // Date updates every call; times-called only increments when someone picked up
  d[rc.recent]=dateStr;
  if(who!=='NO CONTACT')d[rc.times]=String((parseInt(d[rc.times])||0)+1);
...
async function saveGenLog(){
  ...
  d[rc.recent]=dateStr;if(who!=='NO CONTACT')d[rc.times]=String((parseInt(d[rc.times])||0)+1);d[rc.outcome]=outcome;d[rc.who]=who;
  if(newNum)d[rc.phone]=d[rc.phone]?d[rc.phone]+'; '+newNum:newNum;
