...
let cfg={},banks=[],logs={},flags={},calls={},apptHeld={},emailLogs={},callMeta={},blackbox={},hqFlags={},hqMeta={},dne={},appFU={},parked={},openRI=null,numCtx=null,genCtx=null,undoCtx=null,workDate='';
...
window.onload=()=>{
  cfg=loadCfg();logs=loadLogs();flags=loadFlags();calls=loadCalls();apptHeld=loadAppt();emailLogs=loadEmailLogs();callMeta=loadCallMeta();blackbox=loadBlackbox();hqFlags=loadHQFlags();hqMeta=loadHQMeta();dne=loadDNE();appFU=loadAFU();parked=loadParked();
...
function toggleFollowupView(){
  ...
  el('btn-followup').textContent=followupOpen?'← Back to banks':'📋 Follow-Ups';
...
function renderList(list){
  ...
  navList=list.slice().sort((a,b)=>{
    const ad=bankHasDueAFU(a.ri)?0:1, bd=bankHasDueAFU(b.ri)?0:1;
    return ad-bd;
  });
  list=navList;
  // Clamp index
