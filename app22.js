...
function renderList(list){
  // Banks with a follow-up due today come first
...
function openFUDDone(ri){
  ...
  let html='';
  if(!role)html+='<div class="warn-box">No role (CEO/CRA/CFO) found in the follow-up person field. Note will go to the Follow-Up sheet only.</div>';
  html+='<div class="form-grid">';
